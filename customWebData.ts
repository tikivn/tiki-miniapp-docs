  ...
  tags: [
      ...
      attributes: [
        {
          name: "type",
          description:
            "Loại icon hiển thị. Giá trị hợp lệ bao gồm: home, search, calendar, location, setting, contact, chat, info, warning, success, plus, minus, geometry, close, close_circle, more, arrow_right, arrow_left, arrow_down, arrow_up, bookmark, app_home, phone_home, share, warning_glyph, success_glyph, close_glyph",
          type: "string",
        },
        {
          name: "size",
      ...
      attributes: [
        {
          name: "selectable",
          description:
            "Cho phép nội dung có thể được chọn hay không, nếu là true thì có thể chọn và sao chép nội dung",
          type: "boolean",
        },
        {
          name: "number-of-lines",
          description:
            "Số dòng tối đa mà nội dung trong text được hiển thị, nếu quá số dòng sẽ hiển thị ... ở cuối",
          type: "number",
        },
      ],
      references: [
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "loading",
          description:
            "Hiển thị icon loading. Khi hiển thị loading, button không thể tap được",
          type: "boolean",
        },
        {
          name: "disabled",
          description:
            "Disabled button, bạn không thể tap khi disabled là true",
          type: "boolean",
        },
        {
          name: "form-type",
          description:
            "Giá trị là submit hoặc reset. Sử dụng với , khi tap vào button sẽ gọi sự kiện onSubmit hoặc onReset của form",
          type: "string",
        },
        {
          name: "onTap",
      ...
      attributes: [
        {
          name: "name",
          description:
            "Khai báo name khi được sử dụng trong , được sử dụng để lấy value cho form",
          type: "string",
        },
        {
          name: "onChange",
          description:
            "Sự kiện được gọi khi giá trị của các checkbox bên trong bị thay đổi, event.detail = { value: value }, giá trị của value là một mảng các value của các checkbox được chọn",
          type: "function",
        },
      ],
      references: [
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "value",
          description:
            "Giá trị của checkbox. Cần được khai báo khi sử dụng bên trong ",
          type: "string",
        },
        {
          name: "checked",
        ...
        },
        {
          name: "disabled",
          description:
            "Disable checkbox, khi giá trị là true bạn sẽ không thay đổi giá trị của checkbox khi tap được",
          type: "boolean",
        },
        {
          name: "color",
        ...
        },
        {
          name: "icon",
          description:
            "Loại icon hiển thị khi checkbox được chọn. Chỉ hỗ trợ 2 loại icon là success và minus (). Giá trị mặc định là success",
          type: "string",
        },
        {
          name: "onChange",
          description:
            "Sự kiện được gọi khi giá trị bị thay đổi, event.detail = { value: value }. Giá trị của value là true/false tùy vào checkbox được chọn hay không",
          type: "event",
        },
      ],
      references: [
      ...
      attributes: [
        {
          name: "onSubmit",
          description:
            'Sự kiện được gọi khi button bên trong form với form-type="submit" được tap vào, event.detail = { value }, trong đó value là một object chứa các giá trị của các component bên trong form',
          type: "event",
        },
        {
          name: "onReset",
          description:
            'Sự kiện được gọi khi button bên trong form với form-type="reset" được tap vào, khi đó giá trị của các component trong form sẽ bị đưa về giá trị ban đầu',
          type: "event",
        },
      ],
      references: [
      ...
      attributes: [
        {
          name: "type",
          description:
            "Loại input. Hỗ trợ các giá trị text/email/number/decimal/tel/search/url. Lưu ý: một số type sẽ không có hiệu lực trên Simulator của Studio mà bạn phải chạy trên device thật.",
          type: "string",
        },
        {
          name: "password",
        ...
        },
        {
          name: "confirm-type",
          description:
            "Nội dung hiển thị cho phím return (Nhập) trên bàn phím (Keyboard). <br />Hỗ trợ các giá trị enter/done/go/next/previous/search/send",
          type: "string",
        },
        {
          name: "selection-start",
          description:
            "Vị trí bắt đầu của con trỏ. Chỉ có hiệu lực trong khi focus là true",
          type: "number",
        },
        {
          name: "selection-end",
          description:
            "Vị trí kết thúc của con trỏ. Chỉ có hiệu lực khi focus là true và cần được sử dụng chung với selection-start",
          type: "number",
        },
        {
          name: "cursor",
        ...
        },
        {
          name: "controlled",
          description:
            "Khi giá trị là true, nội dung value của input sẽ được điều khiển hoàn toàn thông qua hàm setData trong file js",
          type: "boolean",
        },
        {
          name: "onInput",
      ...
      attributes: [
        {
          name: "value",
          description:
            'Chỉ định giá trị được chọn trong các picker-view-column (bắt đầu từ 0), số lượng phần tử trong mảng nên trùng với số picker-view-column đang hiển thị. Ví dụ bản có 2 picker-view-column trong picker-view, bạn muốn ở picker-view-column đầu tiên chọn index thứ 1, ở picker-view-column thứ 2 chọn index đầu tiên, bạn khai báo value="{{[1, 0]}}".<br /> Nếu bạn không khai báo thì mặc định sẽ là index đầu tiên được chọn',
          type: "number array",
        },
        {
          name: "indicator-style",
          description:
            "Inline style cho indicator, là phần nằm giữa chỗ index đang được chọn",
          type: "string",
        },
        {
        ...
        },
        {
          name: "onChange",
          description:
            "Sự kiện được gọi khi giá trị bị thay đổi, event.detail = { value: value }, trong đó value là mảng các index đang được chọn trong picker-column",
          type: "event",
        },
      ],
      references: [
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "range",
          description:
            "Mảng các phần tử hiển thị trong picker, nếu bạn khai báo một mảng các đối tượng, bạn cần khai báo thêm range-key",
          type: "array string / array object",
        },
        {
          name: "confirm-button-text",
          description:
            "Nội dung của button dưới footer, mặc định là OK. Chỉ support framework version từ 1.73.5 trở lên",
          type: "string",
        },
        {
          name: "confirm-button-class",
          description:
            "Class của button dưới footer. Chỉ support framework version từ 1.73.5 trở lên",
          type: "string",
        },
        {
          name: "rang-key",
        ...
        },
        {
          name: "onChange",
          description:
            "Sự kiện được gọi khi giá trị bị thay đổi, event.detail = { value: value }, trong đó value là index của item được chọn",
          type: "event",
        },
        {
          name: "disabled",
          description:
            "Nếu giá trị là true, khi bạn bấm vào picker thì sẽ không hiển thị",
          type: "boolean",
        },
      ],
      references: [
      ...
      attributes: [
        {
          name: "onChange",
          description:
            "Sự kiện được gọi khi giá trị của các radio bị thay đổi, event.detail = { value: value }, value chính là giá trị của radio đang được chọn",
          type: "function",
        },
        {
          name: "name",
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "checked",
          description:
            "Chỉ định radio có được chọn hay không. Mặc định là false",
          type: "boolean",
        },
        {
          name: "disabled",
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "onChange",
          description:
            "Sự kiện được gọi khi giá trị bị thay đổi và người dùng đã không còn chạm vào slider, event.detail = { value: value }",
          type: "event",
        },
        {
          name: "onChanging",
          description:
            "Sự kiện được gọi khi giá trị bị thay đổi và người dùng vẫn còn chạm vào slider, event.detail = { value: value }",
          type: "event",
        },
      ],
      references: [
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "controlled",
          description:
            "Khi giá trị là true, giá trị của switch sẽ được điều khiển hoàn toàn thông qua hàm setData trong file js",
          type: "boolean",
        },
        {
          name: "checked",
        ...
        },
        {
          name: "controlled",
          description:
            "Nếu giá trị là true, giá trị của component chỉ thay đổi thông qua setData",
          type: "boolean",
        },
      ],
      references: [
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "auto-height",
          description:
            "Tự động tăng chiều cao. (Bạn không nên set max-height và min-height cho textarea nếu giá trị của thuộc tính này là true)",
          type: "boolean",
        },
        {
          name: "show-count",
        ...
        },
        {
          name: "controlled",
          description:
            "Khi giá trị là true, nội dung value của textarea sẽ được điều khiển hoàn toàn thông qua hàm setData trong file js",
          type: "boolean",
        },
        {
          name: "onInput",
          description:
            "Sự kiện sẽ được gọi khi nội dung của textarea bị thay đổi, event.detail = { value: value }",
          type: "event",
        },
        {
          name: "onConfirm",
        ...
        },
        {
          name: "onFocus",
          description:
            "Sự kiện sẽ được gọi khi textarea được focus , event.detail = { value: value }",
          type: "event",
        },
        {
          name: "onBlur",
          description:
            "Sự kiện sẽ được gọi khi textarea không được focus nữa , event.detail = { value: value }",
          type: "event",
        },
      ],
      references: [
      ...
      attributes: [
        {
          name: "api-key",
          description:
            "Key của google maps, bạn có thể tham khảo cách tạo key ",
          type: "string",
        },
        {
          name: "latitude",
        ...
        },
        {
          name: "markers",
          description:
            "Mảng các marker. Bạn có thể xem cấu hình marker bên dưới",
          type: "array marker",
        },
        {
          name: "polygon",
          description:
            "Mảng các polygon. Bạn có thể xem cấu hình polygon bên dưới",
          type: "array polygon",
        },
        {
          name: "polyline",
          description:
            "Mảng các polyline. Bạn có thể xem cấu hình polyline bên dưới",
          type: "array polyline",
        },
        {
          name: "circles",
          description:
            "Mảng các circle. Bạn có thể xem cấu hình circle bên dưới",
          type: "array circle",
        },
        {
          name: "onMarkerTap",
          description:
            "Sự kiện được gọi khi bấm vào marker. Có chứa các thông tin: { markerId, latitude, longitude }",
          type: "event",
        },
        {
          name: "onTap",
          description: "Sự kiện được gọi khi bấm vào map",
          type: "event",
        },
        {
          name: "onRegionChange",
          description:
            "Sự kiện được gọi khi người dùng kéo/thả làm thay đổi phạm vi của map. Có chứa các thông tin { latitude, longitude, zoom }",
          type: "event",
        },
      ],
      references: [
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "loop",
          description:
            "Khi được chỉ định, audio player sẽ tự động phát lại khi phát tới cuối nội dung.",
          type: "boolean",
        },
        {
          name: "controls",
          description:
            "Cho phép tuỳ chỉnh sử dụng hay không sử dụng controls mặc định của Audio Player.",
          type: "boolean",
        },
        {
          name: "name",
          description:
            "Khi cho phép hiển thị controls, name sẽ được hiển thị trên phần tên của nội dung.",
          type: "string",
        },
        {
          name: "author",
          description:
            "Khi cho phép hiển thị controls, control sẽ được hiển thị trên phần tác giả của nội dung.",
          type: "string",
        },
        {
          name: "onPlay",
        ...
        },
        {
          name: "onTimeUpdate",
          description:
            "Sự kiện được gọi để cập nhật vị trí hiện tại của nội dung theo thời gian.",
          type: "event",
        },
        {
          name: "onError",
          description:
            "Sự kiện được gọi khi có lỗi khi play nội dung. event.detail = { errMsg: 'MEDIA_ERR_NETWORK' }",
          type: "event",
        },
      ],
      references: [
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "default-source",
          description:
            "Hình ảnh mặc định. Nếu giá trị được thiết lập, hình ảnh trong default-source sẽ được hiển thị trước, sau đó sẽ hiển thị hình ảnh trong src sau khi đã được tải thành công. Ngoài ra, hình ảnh này còn được dùng khi hình ảnh không load được (Khi đó onError sẽ được gọi)",
          type: "string",
        },
        {
          name: "mode",
          description:
            "Chế độ hiển thị của hình ảnh. Mặc định là scaleToFill. Bạn có thể xem các mode được hỗ trợ bên dưới. Chỉ hỗ trợ version từ 1.76.5 trở lên",
          type: "string",
        },
        {
          name: "onTap",
          description:
            "Sự kiện được gọi khi tap vào image. Chỉ hỗ trợ version >= 1.74.22",
          type: "event",
        },
        {
          name: "catchTap",
          description:
            "Sự kiện được gọi khi tap vào image, tuy nhiên event sẽ không buble lên parent. Chỉ hỗ trợ version >= 1.74.22",
          type: "event",
        },
        {
          name: "onLoad",
      ...
      attributes: [
        {
          name: "path",
          description:
            "Đường dẫn tới nội dung của file json. Hỗ trợ các file local hoặc remote",
          type: "string",
        },
        {
          name: "autoplay",
        ...
        },
        {
          name: "onDataFailed",
          description:
            "Sự kiện được gọi nội dung của lottie tải không thành công",
          type: "event",
        },
        {
          name: "onDataReady",
          description:
            "Sự kiện được gọi khi nội dung của lottie được load xong",
          type: "event",
        },
        {
          name: "onLoopComplete",
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "loop",
          description:
            "Khi được chỉ định, video player sẽ tự động phát lại khi phát tới cuối nội dung.",
          type: "boolean",
        },
        {
          name: "autoplay",
        ...
        },
        {
          name: "controls",
          description:
            "Cho phép tuỳ chỉnh sử dụng hay không sử dụng controls mặc định củas Video Player.",
          type: "boolean",
        },
        {
          name: "object-fit",
          description:
            "Cách thể hiện của video khi kích thước của video khác với video container. Các giá trị bao gồm: 'fill', 'contain', 'cover', 'none' và 'scale-down'. Giá trị mặc định là 'contain'.",
          type: "string",
        },
        {
          name: "plays-inline",
          description:
            "Mặc định video sẽ được mở fullscreen khi phát, quy định thuộc tính này cho phép phát video tại chỗ.",
          type: "boolean",
        },
        {
          name: "poster",
    ...
    },
    {
      ...
      attributes: [
        {
          name: "indicator-dots",
          description: "Cho phép hiển thị dot",
          type: "boolean",
        },
        {
          name: "indicator-color",
          description: "Màu của dot",
          type: "string",
        },
        {
          name: "indicator-active-color",
          description: "Màu của dot đang được active",
          type: "string",
        },
        {
          name: "active-class",
          description:
            "Class được thêm vào carousel-item khi item đó được chọn",
          type: "string",
        },
        {
          name: "autoplay",
          description: "Cho phép autoplay",
          type: "boolean",
        },
        {
          name: "current",
          description:
            "Chỉ được item được active với giá trị truyền vào là vị trí của item đó (bắt đầu từ 0)",
          type: "number",
        },
        {
          name: "duration",
          description: "Thời gian để thực hiện hiệu ứng đổi item",
          type: "number",
        },
        {
          name: "interval",
          description: "Thời gian để một item tự chuyển đổi qua item khác",
          type: "number",
        },
        {
          name: "vertical",
          description:
            "Hiển thị carousel theo chiều dọc, cần khai báo chiều cao cho carousel thông qua thuộc tính height ở style hoặc class",
          type: "number",
        },
        {
          name: "circular",
          description: "Cho phép carousel thực hiện lặp vô tận",
          type: "boolean",
        },
        {
          name: "disable-touch",
          description:
            "Cho phép user có thể touch được vào carousel để lướt hay không",
          type: "boolean",
        },
        {
          name: "spacing",
          description:
            "Khoảng cách giữa các item (đơn vị px). Chỉ hỗ trợ version >= 1.74.23",
          type: "number",
        },
        {
          name: "onChange",
      ...
      attributes: [
        {
          name: "scale-area",
          description:
            "Khi các movable-view cho phép scaling. Bạn có thể dùng thuộc tính này để tắt việc scaling của tất cả component ở trong area.",
          type: "boolean",
        },
      ],
      references: [
      ...
      attributes: [
        {
          name: "direction",
          description:
            'Các hướng mà thành phần có thể di chuyển được. Giá trị của direction bao gồm "all", "vertical", "horizontal" và "none".',
          type: "string",
        },
        {
          name: "inertia",
          description:
            "Khi thuộc tính này xác định, movable-view sẽ có quán tính sau khi thả ra.",
          type: "boolean",
        },
        {
          name: "out-of-bounds",
          description:
            "Khi thuốc tính này xác định, movable-view có thể di chuyển ra ngoài movable-area.",
          type: "boolean",
        },
        {
          name: "x",
        ...
        },
        {
          name: "damping",
          description:
            "Khi thuộc tính out-of-bounds được bật, sau khi di chuyển ra ngoài movable area view sẽ có hiệu ứng bật ngược lại.",
          type: "number",
        },
        {
          name: "friction",
        ...
        },
        {
          name: "scale",
          description:
            "Xác định cho phép view scale bằng 2 ngón tay được không.",
          type: "boolean",
        },
        {
          name: "scale-min",
        ...
        },
        {
          name: "onChange",
          description:
            "Sự kiện được kích hoạt khi view được di chuyển. event.detail = { x, y source }",
          type: "EventHandle",
        },
        {
          name: "onScale",
          description:
            "Sự kiện được kích hoạt khi view được scale. event.detail = { x, y, scale }",
          type: "EventHandle",
        },
      ],
      references: [
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "animation",
          description:
            "Dùng để kiểm soát animation của thẻ view - chi tiết xem .",
          type: "object",
        },
        {
          name: "onTap",
        ...
        },
        {
          name: "onTouchCancel",
          description:
            "Khi sự kiện touch bị đứt quãng (ví dụ như có điện thoại, có popup hiển thị).",
          type: "EventHandle",
        },
        {
          name: "onLongTap",
          description:
            "Sự kiện được trigger khi giữ nhấn trên màn hình lâu hơn 500ms.",
          type: "EventHandle",
        },
        {
          name: "onTransitionEnd",
          description:
            "Sự kiện được trigger sau khi hoàn thành 1 CSS Transition.",
          type: "EventHandle",
        },
        {
        ...
        },
        {
          ...
          description:
            "Sự kiện được trigger khi kết thúc 1 vòng lặp CSS Animation.",
          type: "EventHandle",
        },
      ],
      references: [
      ...
      attributes: [
        {
          name: "my.navigateTo",
          description:
            "Dùng để di chuyển từ màn hình hiện tại tới màn hình mong muốn trong ứng dụng. Xem thêm .",
          type: "",
        },
        {
          name: "my.navigateBack",
          description:
            "Dùng để đóng màn hình hiện tại và trở lại màn hình trước đó. Xem thêm .",
          type: "",
        },
        {
        ...
        },
        {
          name: "my.getUserInfo",
          description:
            "Dùng để lấy các thông tin cơ bản của users (tên, ảnh). .",
          type: "",
        },
        {
          name: "my.request",
        ...
        },
        {
          name: "my.postMessage",
          description:
            "Dùng để gửi message tới webview. Message sẽ được gửi tới listener của window.onmessage hay window.addEventListener('message', listener).",
          type: "",
        },
      ],
      references: [
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "iconName",
          description:
            "Hiển thị một icon ở vị trí mặc định, icon sẽ bị ẩn nếu loading được đặt về true. Xem danh sách icon .",
          type: "enum()",
        },
        {
          name: "formType",
      ...
      attributes: [
        {
          name: "firstCities",
          description:
            "Chỉ định các tỉnh/thành phố được hiển thị đầu tiên trong danh sách",
          type: "array string",
        },
        {
          name: "street",
        ...
        },
        {
          name: "city",
          description:
            "Mã của tỉnh/thành phố hoặc là một address object. Bạn có thể xem thông tin của address object bên dưới",
          type: "number/Address",
        },
        {
          name: "district",
        ...
        },
        {
          name: "onFullAddress",
          description:
            "Sự kiện được gọi khi các thông tin address được điền đầy đủ",
          type: "event",
        },
      ],
      references: [
      ...
      attributes: [
        {
          name: "padding",
          description:
            "Nếu cờ được bật, list-item sẽ được bao ngoài bởi một phần padding. Chi tiết phần padding này vui lòng xem file Figma của Design System",
          type: "boolean",
        },
        {
          name: "class",
        ...
        },
        {
          name: "thumb",
          description:
            "url cuả thumb image. Nếu thumb không được truyền vào, thumb image sẽ không hiển thị.",
          type: "URL",
        },
        {
          name: "thumbSize",
          description:
            "size của image. Trường này bắt buộc phải truyền nếu như truyền vào thumb",
          type: "number",
        },
        {
          name: "upperSubtitle",
        ...
        },
        {
          name: "titlePosition",
          description:
            "Vị trí của title. Nếu là 'top' thì slot <default> sẽ được render trên đầu của upperSubtitle. Nếu là middle thì <default> được render ở giữa upperSubtitle và lowerSubtitle. Nếu là bottom thì <default> được render ở dưới lowerSubtitle",
          type: "enum('top', 'middle', 'bottom')",
        },
        {
          name: "arrow",
          description:
            "Nếu cờ được bật, thì sẽ render arrow icon ở bên phải của <list-item>.",
          type: "boolean",
        },
        {
          name: "iconSize",
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "buttons",
          description:
            "Custom bottom buttons, implement props  bind function vào button",
          type: "Button[]",
        },
        {
          name: "buttonsLayout",
        ...
        },
        {
          name: "onModalClose",
          description:
            "Function này sẽ được trigger khi click vào close button",
          type: "event",
        },
        {
          name: "onButtonClick",
          description:
            "Function sẽ được bind và trigger khi click vào custom button",
          type: "event",
        },
      ],
      references: [
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "mask",
          description:
            "Hiển thị mask, sử dụng với props onClose để đóng popup khi click vào mask",
          type: "boolean",
        },
        {
          name: "position",
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "shape",
          description:
            "Kiểu border radius của dropdown. Hỗ trợ rounded hoặc pill. Mặc định là rounded",
          type: "string",
        },
        {
          name: "loading",
        ...
        },
        {
          name: "labelKey",
          description:
            "Label key để hiển thị trên bottom sheet, không cần truyền nếu items là mảng string. Ví dụ bạn có mảng [{value: 'Content 1', key: 1}] thì set labelKey=\"Content 1\" thì bottom sheet sẽ hiển thị text",
          type: "string",
        },
        {
          name: "idKey",
          description:
            "Id key để phân biệt các item trên bottom sheet, ví dụ bạn có mảng [{name: 'Content 1', customKey: 1}], thì bạn cần truyền idKey=\"customKey\"",
          type: "string",
        },
        {
          name: "showSearch",
        ...
        },
        {
          ...
          description:
            "Placeholder cho input search, chỉ có hiệu lực khi showSearch=true",
          type: "string",
        },
        {
          name: "labelText",
        ...
        },
        {
          name: "showCheck",
          description:
            "Hiển thị icon check cho item được chọn trong bottom sheet. Sẽ tự động ẩn nếu multiple=true",
          type: "string",
        },
        {
          name: "multiple",
        ...
        },
        {
          name: "onTap",
          description:
            "Sự kiện được gọi khi một item trên bottom sheet được chọn",
          type: "event",
        },
        {
          name: "onSelect",
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "step",
          description:
            "giá trị mỗi lần tăng hoặc giảm, step có thể nhận giá trị kiểu double",
          type: "number",
        },
        {
          name: "disabled",
        ...
        },
        {
          name: "readOnly",
          description:
            "nếu cờ được bật lên, users không thể thay đổi giá trị của stepper",
          type: "boolean",
        },
        {
          name: "showNumber",
        ...
        },
        {
          name: "vertical",
          description:
            "nếu cờ này được bật, stepper sẽ được hiện thị theo chiều dọc thay vì chiều ngang",
          type: "boolean",
        },
        {
          name: "onChange",
          description:
            "sự kiện được gọi khi giá trị thay đổi, với data có dạng (value: Number, mode: String) => void",
          type: "event",
        },
      ],
      references: [
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "failIndex",
          description:
            "Index của step bị bỏ qua, step chưa hoàn thành hoặc lỗi",
          type: "number | null",
        },
        {
          name: "items",
          description:
            "Danh sách các step. Bạn có thể truyền title hoặc description rỗng và sử dụng custom slot để chỉnh sửa item như ví dụ trên",
        ...
        },
        {
          name: "dotErrorColor",
          description:
            "Màu của dot khi step được đánh dấu error(index === failIndex)",
          type: "string",
        },
        {
          name: "dotSize",
        ...
        },
        {
          ...
          description:
            "Đảo ngược hướng của các vertical steps theo chiều bắt đầu từ dưới lên trên",
          type: "boolean",
        },
      ],
      references: [
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "labelIcon",
          description:
            "Icon type hiển thị trên label, bạn có thể tim thêm các icon type tại ",
          type: "string",
        },
        {
          name: "labelIconColor",
        ...
        },
        {
          name: "shape",
          description:
            "Kiểu border radius của input. Hỗ trợ rounded hoặc pill. Mặc định là rounded",
          type: "string",
        },
        {
          name: "loading",
        ...
        },
        {
          name: "hasError",
          description:
            "Khi giá trị là true, input sẽ có viền màu đỏ (mã #ff424f), và xuất hiện icon thông báo lỗi",
          type: "boolean",
        },
        {
          name: "errorMsg",
          description:
            "Hiển thị thông báo lỗi bên dưới input, cần khai báo thêm hasError=true",
          type: "string",
        },
        {
          name: "errorIconColor",
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "overflowCount",
          description:
            "khi giá trị text là kiểu số và lớn hơn overflowCount, thì sẽ hiển thị ..., ngược lại hiển thị giá trị text",
          type: "number",
        },
        {
          name: "withArrow",
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "activeChild",
          description:
            "Chỉ định item con được active theo index, chỉ được khai báo khi item có children",
          type: "number",
        },
        {
          name: "width",
        ...
        },
        {
          name: "items",
          description:
            "Mảng các đối tượng, bạn có thể xem cấu hình của items ở bên dưới",
          type: "array",
        },
        {
          name: "direction",
          description:
            "Chỉ định direction cho các phần tử bên trong tab (title, image, icon). Hỗ trợ horizontal và vertical",
          type: "string",
        },
        {
          name: "animated",
        ...
        },
        {
          ...
          description:
            "Màu của sidebar line khi item đó được active và sidebarlineShow=true",
          type: "string",
        },
        {
        ...
        },
        {
          name: "onItemClick",
          description:
            "Sự kiện được gọi khi bấm vào item, với data có dạng: (index: number) => void",
          type: "event",
        },
        {
          name: "onChildClick",
          description:
            "Sự kiện được gọi khi bấm vào child, với data có dạng: (parentIndex: number, index: number) => void",
          type: "event",
        },
      ],
      references: [
    ...
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "tabs",
          description:
            "Mảng các đối tượng tab, bạn có thể xem cấu hình của tab ở bên dưới",
          type: "array",
        },
        {
          name: "activeTab",
        ...
        },
        {
          name: "duration",
          description:
            "Khoảng thời gian để đổi tab content, chỉ có hiệu lực khi swipeable=true",
          type: "number",
        },
        {
          name: "hasSubTitle",
        ...
        },
        {
          ...
          description:
            "Chiều cao của tab content, có hiệu lực khi swipeable=true",
          type: "string",
        },
        {
          name: "stickyBar",
        ...
        },
        {
          name: "onTabClick",
          description:
            "Sự kiện được gọi khi bấm vào tab, event.detail = { index, tabsName }",
          type: "event",
        },
        {
          name: "onChange",
          description:
            "Sự kiện được gọi khi đổi tab, event.detail = { index, tabsName }",
          type: "event",
        },
      ],
      references: [
