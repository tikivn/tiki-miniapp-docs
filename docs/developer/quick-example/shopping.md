...
**1.2. Hiển thị sản phẩm bên trong [tabs](https://developers.tiki.vn/docs/component/view-container/tabs).**
...
Sử dụng [scroll-view](https://developers.tiki.vn/docs/component/view-container/scroll-view) để hiển thị danh sách cách sản phẩm trong giỏ hàng.
